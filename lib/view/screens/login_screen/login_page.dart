...
import 'package:dved_task/view/widgets/menu_widget.dart';
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  SelectCompany.selectCompany(ctx),
                SizedBox(height: ctx.h*0.01),
                ctx.watch<AuthViewModel>().isOpenMenu
                    ? Column(
                      children: [
                        MenuWidget.buildMenu(ctx),
                        SizedBox(height: ctx.h*0.053,)
                      ],
                    )
                    :  Column(
                    children: [
